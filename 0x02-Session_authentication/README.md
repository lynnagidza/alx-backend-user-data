...
This project focuses on what authentication means, what session authentication means and what this implies, what cookies are and what is their purpose and use, how to send cookies, how to parse cookies and how to use Python requests module.\
This project borrows from **[0x01. Basic authentication](../0x01-Basic_authentication/)** and therefore contains all files and tasks previously done.

## Requirements
[![ubuntu](https://img.shields.io/badge/ubuntu-18.04_LTS-orange.svg)](https://www.ubuntu.com/download/desktop)
[![python3](https://img.shields.io/badge/python-3.7-yellow.svg)](https://www.python.org/downloads/release/python-3717/)
[![pycodestyle](https://img.shields.io/badge/pycodestyle-2.5-blue.svg)](https://pypi.org/project/pycodestyle/2.5.0/)

## Tasks
### 0. Et moi et moi et moi!
Copy all work of the **[0x01. Basic authentication](../0x01-Basic_authentication/)** project in this new folder.
...
- Create an instance method `def create_session(self, user_id: str = None) -> str:` that creates a Session ID for a `user_id`: 
    ...
    * Otherwise: 
        * Generate a Session ID using    module and `uuid4()` like `id` in `Base`
...
- You must use `.get()` built-in for accessing in a dictionary a value based on a key
